...
var kha__$Assets_ImageList = $hxClasses["kha._Assets.ImageList"] = function() {
	...
	this.bodyPartsDescription = { name : "bodyParts", original_height : 480, file_sizes : [709], original_width : 32, files : ["bodyParts.png"], type : "image"};
...
var kha__$Assets_BlobList = $hxClasses["kha._Assets.BlobList"] = function() {
	...
	this.tiles_tsx = null;
	this.tiles_jsonDescription = { name : "tiles_json", file_sizes : [563], files : ["tiles.json"], type : "blob"};
	...
	this.tiles_ase = null;
	this.map_tmxDescription = { name : "map_tmx", file_sizes : [26946], files : ["map.tmx"], type : "blob"};
	this.map_tmxName = "map_tmx";
	this.map_tmx = null;
	this.bodyParts_jsonDescription = { name : "bodyParts_json", file_sizes : [1478], files : ["bodyParts.json"], type : "blob"};
	...
	this.bodyParts2_jsonDescription = { name : "bodyParts2_json", file_sizes : [1212], files : ["bodyParts2.json"], type : "blob"};
