...
class HXCPP_CLASS_ATTRIBUTES Goblin_obj : public  ::bonsai::entity::Entity_obj
{
	...
	public:
		enum { _hx_ClassId = 0x50743329 };

		void __construct(Float x,Float y);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="game.Goblin")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"game.Goblin"); }
