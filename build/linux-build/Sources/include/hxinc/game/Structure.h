...
#define INCLUDED_game_Structure
...
class HXCPP_CLASS_ATTRIBUTES Structure_obj : public  ::bonsai::entity::Entity_obj
{
	public:
		typedef  ::bonsai::entity::Entity_obj super;
		typedef Structure_obj OBJ_;
		Structure_obj();

	public:
		enum { _hx_ClassId = 0x04cb36a1 };

		void __construct(::String tmx);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="game.Structure")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"game.Structure"); }
		static hx::ObjectPtr< Structure_obj > __new(::String tmx);
		static hx::ObjectPtr< Structure_obj > __alloc(hx::Ctx *_hx_ctx,::String tmx);
		...
		::String __ToString() const { return HX_("Structure",13,34,22,e9); }
