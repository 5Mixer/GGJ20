...
class HXCPP_CLASS_ATTRIBUTES Input_obj : public hx::Object
{
	...
	public:
		...
		::Array< ::Dynamic> mouseUpListeners;
		inline ::Array< ::Dynamic> _hx_set_mouseUpListeners(hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return mouseUpListeners=_hx_v; }
