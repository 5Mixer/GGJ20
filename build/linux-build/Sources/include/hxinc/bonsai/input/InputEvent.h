...
class InputEvent_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		static ::bonsai::input::InputEvent MouseDown;
		static inline ::bonsai::input::InputEvent MouseDown_dyn() { return MouseDown; }
		...
		static ::bonsai::input::InputEvent MouseUp;
		static inline ::bonsai::input::InputEvent MouseUp_dyn() { return MouseUp; }
};
