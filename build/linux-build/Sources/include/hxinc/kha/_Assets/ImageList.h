...
class HXCPP_CLASS_ATTRIBUTES ImageList_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic bodyParts2Unload_dyn();
		 ...
		 ::kha::Image castleTiles;
		inline  ::kha::Image _hx_set_castleTiles(hx::StackContext *_hx_ctx, ::kha::Image _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return castleTiles=_hx_v; }
		::String castleTilesName;
		inline ::String _hx_set_castleTilesName(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return castleTilesName=_hx_v; }
		 ::Dynamic castleTilesDescription;
		inline  ::Dynamic _hx_set_castleTilesDescription(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return castleTilesDescription=_hx_v; }
		void castleTilesLoad( ::Dynamic done, ::Dynamic failure);
		::Dynamic castleTilesLoad_dyn();

		void castleTilesUnload();
		::Dynamic castleTilesUnload_dyn();
