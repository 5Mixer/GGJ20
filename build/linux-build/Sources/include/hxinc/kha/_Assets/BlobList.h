...
class HXCPP_CLASS_ATTRIBUTES BlobList_obj : public hx::Object
{
	...
	public:
		...
		::Dynamic satanicCircle_aseUnload_dyn();
		 ...
		 ::kha::internal::BytesBlob skeletune_sunvox;
		inline  ::kha::internal::BytesBlob _hx_set_skeletune_sunvox(hx::StackContext *_hx_ctx, ::kha::internal::BytesBlob _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return skeletune_sunvox=_hx_v; }
		::String skeletune_sunvoxName;
		inline ::String _hx_set_skeletune_sunvoxName(hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return skeletune_sunvoxName=_hx_v; }
		 ::Dynamic skeletune_sunvoxDescription;
		inline  ::Dynamic _hx_set_skeletune_sunvoxDescription(hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return skeletune_sunvoxDescription=_hx_v; }
		void skeletune_sunvoxLoad( ::Dynamic done, ::Dynamic failure);
		::Dynamic skeletune_sunvoxLoad_dyn();

		void skeletune_sunvoxUnload();
		::Dynamic skeletune_sunvoxUnload_dyn();
