...
HX_DEFINE_STACK_FRAME(_hx_pos_f3f77c63b1961605_255_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/home/mixer/projects/GGJ20/Kha/Tools/haxe/std/haxe/ds/BalancedTree.hx",255,0xa715fd00)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,hx::Null< int >  __o_h){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_f3f77c63b1961605_255_new)
HXLINE( 256)		this->_hx_set_left(HX_CTX, l);
HXLINE( 257)		this->_hx_set_key(HX_CTX, k);
HXLINE( 258)		this->_hx_set_value(HX_CTX, v);
HXLINE( 259)		this->_hx_set_right(HX_CTX, r);
HXLINE( 260)		if ((h == -1)) {
