...
HX_LOCAL_STACK_FRAME(_hx_pos_640ca3106491fd60_47_readMessage,"sys.thread._Thread.Thread_Impl_","readMessage",0x4f379df5,"sys.thread._Thread.Thread_Impl_.readMessage","/home/mixer/projects/GGJ20/Kha/Tools/haxe/std/cpp/_std/sys/thread/Thread.hx",47,0x9dd7c38f)
namespace sys{
namespace thread{
namespace _Thread{
...
bool Thread_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x24422200;
}

 ::Dynamic Thread_Impl__obj::readMessage(bool block){
            	HX_STACKFRAME(&_hx_pos_640ca3106491fd60_47_readMessage)
