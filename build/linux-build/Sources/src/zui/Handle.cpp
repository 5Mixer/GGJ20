...
HX_DEFINE_STACK_FRAME(_hx_pos_a404387ea021c3c1_1460_new,"zui.Handle","new",0x10476fda,"zui.Handle.new","Sources/zui/Zui.hx",1460,0xe279dd08)
HX_LOCAL_STACK_FRAME(_hx_pos_a404387ea021c3c1_1490_nest,"zui.Handle","nest",0x2e3a6bde,"zui.Handle.nest","Sources/zui/Zui.hx",1490,0xe279dd08)
HX_LOCAL_STACK_FRAME(_hx_pos_a404387ea021c3c1_1501_unnest,"zui.Handle","unnest",0xfa555037,"zui.Handle.unnest","Sources/zui/Zui.hx",1501,0xe279dd08)
HX_LOCAL_STACK_FRAME(_hx_pos_a404387ea021c3c1_1506_boot,"zui.Handle","boot",0x26536f78,"zui.Handle.boot","Sources/zui/Zui.hx",1506,0xe279dd08)
namespace zui{

void Handle_obj::__construct( ::Dynamic ops){
            	HX_GC_STACKFRAME(&_hx_pos_a404387ea021c3c1_1460_new)
HXLINE(1476)		this->changed = false;
HXLINE(1475)		this->dragY = 0;
HXLINE(1474)		this->dragX = 0;
HXLINE(1473)		this->dragEnabled = false;
HXLINE(1472)		this->lastMaxY = ((Float)0.0);
HXLINE(1471)		this->lastMaxX = ((Float)0.0);
HXLINE(1470)		this->layout = 0;
HXLINE(1469)		this->scrollEnabled = false;
HXLINE(1468)		this->scrollOffset = ((Float)0.0);
HXLINE(1467)		this->redraws = 2;
HXLINE(1466)		this->_hx_set_texture(HX_CTX, null());
HXLINE(1465)		this->_hx_set_text(HX_CTX, HX_("",00,00,00,00));
HXLINE(1464)		this->value = ((Float)0.0);
HXLINE(1463)		this->color = -1;
HXLINE(1462)		this->position = 0;
HXLINE(1461)		this->selected = false;
HXLINE(1480)		if (hx::IsNotNull( ops )) {
HXLINE(1481)			if (hx::IsNotNull( ops->__Field(HX_("selected",5b,2a,6d,b1),hx::paccDynamic) )) {
HXLINE(1481)				this->selected = ( (bool)(ops->__Field(HX_("selected",5b,2a,6d,b1),hx::paccDynamic)) );
            			}
HXLINE(1482)			if (hx::IsNotNull( ops->__Field(HX_("position",a9,a0,fa,ca),hx::paccDynamic) )) {
HXLINE(1482)				this->position = ( (int)(ops->__Field(HX_("position",a9,a0,fa,ca),hx::paccDynamic)) );
            			}
HXLINE(1483)			if (hx::IsNotNull( ops->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic) )) {
HXLINE(1483)				this->value = ( (Float)(ops->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
            			}
HXLINE(1484)			if (hx::IsNotNull( ops->__Field(HX_("text",ad,cc,f9,4c),hx::paccDynamic) )) {
HXLINE(1484)				this->_hx_set_text(HX_CTX, ( (::String)(ops->__Field(HX_("text",ad,cc,f9,4c),hx::paccDynamic)) ));
            			}
HXLINE(1485)			if (hx::IsNotNull( ops->__Field(HX_("color",63,71,5c,4a),hx::paccDynamic) )) {
HXLINE(1485)				this->color = ( (int)(ops->__Field(HX_("color",63,71,5c,4a),hx::paccDynamic)) );
            			}
HXLINE(1486)			if (hx::IsNotNull( ops->__Field(HX_("layout",aa,ae,b8,58),hx::paccDynamic) )) {
HXLINE(1486)				this->layout = ( (int)(ops->__Field(HX_("layout",aa,ae,b8,58),hx::paccDynamic)) );
            			}
            		}
            	}
...
bool Handle_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::zui::Handle Handle_obj::nest(int i, ::Dynamic ops){
            	HX_GC_STACKFRAME(&_hx_pos_a404387ea021c3c1_1490_nest)
HXLINE(1491)		if (hx::IsNull( this->children )) {
HXLINE(1491)			this->_hx_set_children(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
            		}
HXLINE(1492)		 ::zui::Handle c = ( ( ::zui::Handle)(this->children->get(i)) );
HXLINE(1493)		if (hx::IsNull( c )) {
HXLINE(1494)			c =  ::zui::Handle_obj::__alloc( HX_CTX ,ops);
HXLINE(1495)			this->children->set(i,c);
            		}
HXLINE(1497)		return c;
            	}
...
void Handle_obj::unnest(int i){
            	HX_STACKFRAME(&_hx_pos_a404387ea021c3c1_1501_unnest)
HXDLIN(1501)		if (hx::IsNotNull( this->children )) {
HXLINE(1502)			this->children->remove(i);
            		}
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_a404387ea021c3c1_1506_boot)
HXDLIN(1506)		global =  ::zui::Handle_obj::__alloc( HX_CTX ,null());
            	}
}
