...
HX_LOCAL_STACK_FRAME(_hx_pos_ff75d527b55e4390_31_render,"game.TileMap","render",0x7672ecd2,"game.TileMap.render","game/TileMap.hx",31,0x1572d9cd)
HX_LOCAL_STACK_FRAME(_hx_pos_ff75d527b55e4390_43_update,"game.TileMap","update",0xf84f0785,"game.TileMap.update","game/TileMap.hx",43,0x1572d9cd)
namespace game{
...
void TileMap_obj::render( ::kha::graphics2::Graphics graphics){
            	HX_STACKFRAME(&_hx_pos_ff75d527b55e4390_31_render)
HXLINE(  32)		this->transformation->apply(graphics);
HXLINE(  34)		{
HXLINE(  34)			int _g = 0;
HXDLIN(  34)			int _g1 = this->width;
HXDLIN(  34)			while((_g < _g1)){
HXLINE(  34)				_g = (_g + 1);
HXDLIN(  34)				int y = (_g - 1);
HXLINE(  35)				{
HXLINE(  35)					int _g2 = 0;
HXDLIN(  35)					int _g11 = this->height;
HXDLIN(  35)					while((_g2 < _g11)){
HXLINE(  35)						_g2 = (_g2 + 1);
HXDLIN(  35)						int x = (_g2 - 1);
HXLINE(  36)						this->spriteMap->render(graphics,( (float)((x * 16)) ),( (float)((y * 16)) ),(this->tiled->tiles->__get(y).StaticCast< ::Array< int > >()->__get(x) - 1));
            					}
            				}
            			}
            		}
...
void TileMap_obj::update(Float dt){
            	HX_STACKFRAME(&_hx_pos_ff75d527b55e4390_43_update)
            	}
