...
HX_DEFINE_STACK_FRAME(_hx_pos_283631fa0fa340d1_20_new,"game.Body","new",0x2a28acb0,"game.Body.new","game/Body.hx",20,0xdfd7eadf)
static const int _hx_array_data_4a50d4be_1[] = {
	(int)0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_283631fa0fa340d1_63_render,"game.Body","render",0x57a72106,"game.Body.render","game/Body.hx",63,0xdfd7eadf)
namespace game{

void Body_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_283631fa0fa340d1_20_new)
HXLINE(  40)		 ::haxe::ds::EnumValueMap _g =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN(  40)		_g->set(::game::LegPart_obj::NaturalLeg_dyn(),2);
HXDLIN(  40)		_g->set(::game::LegPart_obj::Boots_dyn(),0);
HXDLIN(  40)		this->_hx_set_legLayers(HX_CTX, _g);
HXLINE(  34)		 ::haxe::ds::EnumValueMap _g1 =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN(  34)		_g1->set(::game::ArmPart_obj::NaturalArm_dyn(),3);
HXDLIN(  34)		_g1->set(::game::ArmPart_obj::Knife_dyn(),4);
HXDLIN(  34)		_g1->set(::game::ArmPart_obj::Sword_dyn(),5);
HXDLIN(  34)		_g1->set(::game::ArmPart_obj::Axe_dyn(),6);
HXDLIN(  34)		this->_hx_set_armLayers(HX_CTX, _g1);
HXLINE(  31)		 ::haxe::ds::EnumValueMap _g2 =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN(  31)		_g2->set(::game::ChestPart_obj::NaturalChest_dyn(),0);
HXDLIN(  31)		this->_hx_set_chestLayers(HX_CTX, _g2);
HXLINE(  28)		 ::haxe::ds::EnumValueMap _g3 =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
...
void Body_obj::render( ::kha::graphics2::Graphics graphics){
            	HX_GC_STACKFRAME(&_hx_pos_283631fa0fa340d1_63_render)
HXLINE(  64)		bool _hx_tmp;
HXDLIN(  64)		bool _hx_tmp1;
HXDLIN(  64)		bool _hx_tmp2;
HXDLIN(  64)		bool _hx_tmp3;
HXDLIN(  64)		bool _hx_tmp4;
HXDLIN(  64)		if (hx::IsNotNull( this->chest )) {
HXLINE(  64)			_hx_tmp4 = hx::IsNull( this->head );
            		}
            		else {
HXLINE(  64)			_hx_tmp4 = true;
            		}
HXDLIN(  64)		if (!(_hx_tmp4)) {
HXLINE(  64)			_hx_tmp3 = hx::IsNull( this->leftLeg );
            		}
            		else {
HXLINE(  64)			_hx_tmp3 = true;
            		}
HXDLIN(  64)		if (!(_hx_tmp3)) {
HXLINE(  64)			_hx_tmp2 = hx::IsNull( this->rightLeg );
            		}
            		else {
HXLINE(  64)			_hx_tmp2 = true;
            		}
HXDLIN(  64)		if (!(_hx_tmp2)) {
HXLINE(  64)			_hx_tmp1 = hx::IsNull( this->leftArm );
            		}
            		else {
HXLINE(  64)			_hx_tmp1 = true;
            		}
HXDLIN(  64)		if (!(_hx_tmp1)) {
HXLINE(  64)			_hx_tmp = hx::IsNull( this->rightArm );
            		}
            		else {
HXLINE(  64)			_hx_tmp = true;
            		}
HXDLIN(  64)		if (_hx_tmp) {
HXLINE(  65)			::haxe::Log_obj::trace(HX_("attempted to render a body that lacks part/s",14,a5,2b,00),hx::SourceInfo(HX_("game/Body.hx",df,ea,d7,df),65,HX_("game.Body",be,d4,50,4a),HX_("render",56,6b,29,05)));
HXLINE(  66)			return;
            		}
HXLINE(  68)		 ::Dynamic _hx_tmp5 = this->chestLayers->get(this->chest);
HXDLIN(  68)		this->animatedSprite->_hx_set_drawLayers(HX_CTX, ::Array_obj< int >::__new(1)->init(0,_hx_tmp5));
HXLINE(  69)		this->animatedSprite->render(graphics,( (float)(this->position->x) ),( (float)(this->position->y) ));
HXLINE(  71)		 ::Dynamic _hx_tmp6 = this->headLayers->get(this->head);
HXDLIN(  71)		this->animatedSprite->_hx_set_drawLayers(HX_CTX, ::Array_obj< int >::__new(1)->init(0,_hx_tmp6));
HXLINE(  72)		this->animatedSprite->render(graphics,( (float)(this->position->x) ),( (float)(this->position->y) ));
HXLINE(  74)		 ::Dynamic _hx_tmp7 = this->legLayers->get(this->leftLeg);
HXDLIN(  74)		this->animatedSprite->_hx_set_drawLayers(HX_CTX, ::Array_obj< int >::__new(1)->init(0,_hx_tmp7));
...
HXLINE(  83)		 ::Dynamic _hx_tmp10 = this->armLayers->get(this->rightArm);
HXDLIN(  83)		this->animatedSprite->_hx_set_drawLayers(HX_CTX, ::Array_obj< int >::__new(1)->init(0,_hx_tmp10));
HXLINE(  84)		this->animatedSprite->render(graphics,( (float)((this->position->x + 7)) ),( (float)(this->position->y) ));
            	}
