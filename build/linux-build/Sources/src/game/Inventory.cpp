...
HX_LOCAL_STACK_FRAME(_hx_pos_90b2490a7e87b451_11_render,"game.Inventory","render",0x4548ab04,"game.Inventory.render","game/Inventory.hx",11,0xf0bf293f)
namespace game{
...
void Inventory_obj::render( ::kha::graphics2::Graphics graphics){
            	HX_GC_STACKFRAME(&_hx_pos_90b2490a7e87b451_11_render)
HXLINE(  12)		int yOffset = 0;
HXLINE(  13)		graphics->set_font(::kha::Assets_obj::fonts->KenneyMini);
HXLINE(  14)		graphics->set_fontSize(10);
HXLINE(  15)		{
HXLINE(  15)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,this->items);
HXDLIN(  15)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  15)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXDLIN(  15)				 ::game::BodyPart item = _g1->__Field(HX_("key",9f,89,51,00),hx::paccDynamic);
HXDLIN(  15)				int quantity = ( (int)(_g1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic)) );
HXLINE(  16)				if ((quantity > 0)) {
HXLINE(  17)					graphics->drawString((((HX_("",00,00,00,00) + quantity) + HX_(" ",20,00,00,00)) + ::Std_obj::string(item)),( (Float)(5) ),( (Float)((yOffset * 10)) ));
HXLINE(  19)					yOffset = (yOffset + 1);
            				}
            			}
            		}
            	}
