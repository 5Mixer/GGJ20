...
HX_DEFINE_STACK_FRAME(_hx_pos_cf6031e51f821794_26_new,"Date","new",0x9aa26240,"Date.new","/home/mixer/projects/GGJ20/Kha/Tools/haxe/std/cpp/_std/Date.hx",26,0x9e976a32)
HX_LOCAL_STACK_FRAME(_hx_pos_cf6031e51f821794_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/home/mixer/projects/GGJ20/Kha/Tools/haxe/std/cpp/_std/Date.hx",105,0x9e976a32)
HX_LOCAL_STACK_FRAME(_hx_pos_cf6031e51f821794_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/home/mixer/projects/GGJ20/Kha/Tools/haxe/std/cpp/_std/Date.hx",112,0x9e976a32)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_cf6031e51f821794_26_new)
...
bool Date_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_cf6031e51f821794_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_cf6031e51f821794_112_fromString)
