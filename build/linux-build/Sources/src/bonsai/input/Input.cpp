...
HX_DEFINE_STACK_FRAME(_hx_pos_fac69f2399d2c853_13_new,"bonsai.input.Input","new",0x4d5b58c4,"bonsai.input.Input.new","bonsai/input/Input.hx",13,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_33_isAnyKeyDown,"bonsai.input.Input","isAnyKeyDown",0xcb607fbb,"bonsai.input.Input.isAnyKeyDown","bonsai/input/Input.hx",33,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_41_mouseDown,"bonsai.input.Input","mouseDown",0xe0829c8b,"bonsai.input.Input.mouseDown","bonsai/input/Input.hx",41,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_48_mouseUp,"bonsai.input.Input","mouseUp",0xaff07e44,"bonsai.input.Input.mouseUp","bonsai/input/Input.hx",48,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_57_mouseMove,"bonsai.input.Input","mouseMove",0xe675873a,"bonsai.input.Input.mouseMove","bonsai/input/Input.hx",57,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_65_mouseWheel,"bonsai.input.Input","mouseWheel",0x7db53452,"bonsai.input.Input.mouseWheel","bonsai/input/Input.hx",65,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_69_mouseLeave,"bonsai.input.Input","mouseLeave",0x264e34ae,"bonsai.input.Input.mouseLeave","bonsai/input/Input.hx",69,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_76_keyDown,"bonsai.input.Input","keyDown",0x8bc4f405,"bonsai.input.Input.keyDown","bonsai/input/Input.hx",76,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_77_keyUp,"bonsai.input.Input","keyUp",0x2344233e,"bonsai.input.Input.keyUp","bonsai/input/Input.hx",77,0x7aa3f3ee)
HX_LOCAL_STACK_FRAME(_hx_pos_fac69f2399d2c853_78_keyPress,"bonsai.input.Input","keyPress",0xab4d8680,"bonsai.input.Input.keyPress","bonsai/input/Input.hx",78,0x7aa3f3ee)
namespace bonsai{
namespace input{

void Input_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_fac69f2399d2c853_13_new)
HXLINE(  24)		this->_hx_set_mouseUpListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  22)		this->_hx_set_downKeys(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  20)		this->mouseInside = true;
HXLINE(  19)		this->absoluteScroll = 0;
HXLINE(  16)		this->mouseRightDown = false;
HXLINE(  15)		this->mouseLeftDown = false;
HXLINE(  27)		this->_hx_set_mousePosition(HX_CTX,  ::kha::math::Vector2_obj::__alloc( HX_CTX ,0,0));
HXLINE(  28)		this->_hx_set_events(HX_CTX,  ::bonsai::event::EventSystem_obj::__alloc( HX_CTX ));
HXLINE(  29)		::kha::input::Mouse_obj::get(null())->notify(this->mouseDown_dyn(),this->mouseUp_dyn(),this->mouseMove_dyn(),this->mouseWheel_dyn(),this->mouseLeave_dyn());
HXLINE(  30)		::kha::input::Keyboard_obj::get(null())->notify(this->keyDown_dyn(),this->keyUp_dyn(),this->keyPress_dyn());
            	}
...
bool Input_obj::isAnyKeyDown(::Array< int > keys){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_33_isAnyKeyDown)
HXLINE(  34)		{
HXLINE(  34)			int _g = 0;
HXDLIN(  34)			while((_g < keys->length)){
HXLINE(  34)				int key = keys->__get(_g);
HXDLIN(  34)				_g = (_g + 1);
HXLINE(  35)				if ((this->downKeys->indexOf(key,null()) != -1)) {
...
void Input_obj::mouseDown(int button,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_41_mouseDown)
HXLINE(  42)		if ((button == 0)) {
HXLINE(  42)			this->mouseLeftDown = true;
            		}
HXLINE(  43)		if ((button == 2)) {
HXLINE(  43)			this->mouseRightDown = true;
            		}
HXLINE(  44)		this->mousePosition->x = x;
HXLINE(  45)		this->mousePosition->y = y;
HXLINE(  46)		this->events->dispatch(::bonsai::input::InputEvent_obj::MouseDown_dyn());
            	}
...
void Input_obj::mouseUp(int button,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_48_mouseUp)
HXLINE(  49)		if ((button == 0)) {
HXLINE(  49)			this->mouseLeftDown = false;
            		}
HXLINE(  50)		if ((button == 2)) {
HXLINE(  50)			this->mouseRightDown = false;
            		}
HXLINE(  51)		this->mousePosition->x = x;
HXLINE(  52)		this->mousePosition->y = y;
HXLINE(  53)		this->events->dispatch(::bonsai::input::InputEvent_obj::MouseUp_dyn());
HXLINE(  54)		{
HXLINE(  54)			int _g = 0;
HXDLIN(  54)			::Array< ::Dynamic> _g1 = this->mouseUpListeners;
HXDLIN(  54)			while((_g < _g1->length)){
HXLINE(  54)				 ::Dynamic listener = _g1->__get(_g);
HXDLIN(  54)				_g = (_g + 1);
HXLINE(  55)				listener();
            			}
            		}
...
void Input_obj::mouseMove(Float x,Float y,int dx,int dy){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_57_mouseMove)
HXLINE(  58)		if (!(this->mouseInside)) {
HXLINE(  59)			this->events->dispatch(::bonsai::input::InputEvent_obj::MouseEnter_dyn());
            		}
HXLINE(  61)		this->mouseInside = true;
HXLINE(  62)		this->mousePosition->x = x;
HXLINE(  63)		this->mousePosition->y = y;
            	}
...
void Input_obj::mouseWheel(int delta){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_65_mouseWheel)
HXLINE(  66)		 ::bonsai::input::Input _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN(  66)		_hx_tmp->absoluteScroll = (_hx_tmp->absoluteScroll + delta);
HXLINE(  67)		this->events->dispatch(::bonsai::input::InputEvent_obj::MouseScroll(delta));
            	}
...
void Input_obj::mouseLeave(){
            	HX_GC_STACKFRAME(&_hx_pos_fac69f2399d2c853_69_mouseLeave)
HXLINE(  70)		this->mouseInside = false;
HXLINE(  71)		this->_hx_set_downKeys(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  72)		this->events->dispatch(::bonsai::input::InputEvent_obj::MouseEnter_dyn());
            	}
...
void Input_obj::keyDown(int key){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_76_keyDown)
HXDLIN(  76)		this->downKeys->push(key);
            	}
...
void Input_obj::keyUp(int key){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_77_keyUp)
HXDLIN(  77)		this->downKeys->remove(key);
            	}
...
void Input_obj::keyPress(::String _hx_char){
            	HX_STACKFRAME(&_hx_pos_fac69f2399d2c853_78_keyPress)
            	}
...
void Input_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(mouseUpListeners,"mouseUpListeners");
	HX_MARK_END_CLASS();
}
...
void Input_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(mouseUpListeners,"mouseUpListeners");
}
...
hx::Val Input_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"mouseUpListeners") ) { return hx::Val( mouseUpListeners ); }
	}
...
hx::Val Input_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"mouseUpListeners") ) { _hx_set_mouseUpListeners(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
...
void Input_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("mouseUpListeners",7f,d5,a0,27));
...
static hx::StorageInfo Input_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /* ::Array< ::Dynamic> */ ,(int)offsetof(Input_obj,mouseUpListeners),HX_("mouseUpListeners",7f,d5,a0,27)},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String Input_obj_sMemberFields[] = {
	...
	HX_("mouseUpListeners",7f,d5,a0,27),
