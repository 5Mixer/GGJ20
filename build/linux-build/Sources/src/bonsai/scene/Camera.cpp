...
HXLINE(   9)		this->shakeStrength = ((Float)0.);
...
HXLINE(  23)			Float strength = (::Math_obj::random() * this->shakeStrength);
...
void Camera_obj::shake(Float duration,Float strength){
...
hx::Val Camera_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"shakeStrength") ) { shakeStrength=inValue.Cast< Float >(); return inValue; }
		break;
	case 14:
...
static hx::StorageInfo Camera_obj_sMemberStorageInfo[] = {
	...
	{hx::fsFloat,(int)offsetof(Camera_obj,shakeStrength),HX_("shakeStrength",67,a3,22,e0)},
