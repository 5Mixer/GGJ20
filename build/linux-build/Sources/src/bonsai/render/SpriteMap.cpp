...
HXLINE(  19)		int sy = (::Math_obj::floor((( (Float)(index) ) / ( (Float)(this->gridHeight) ))) * this->gridHeight);
HXLINE(  20)		graphics->drawSubImage(this->image,x,y,( (float)(sx1) ),( (float)(sy) ),( (float)(this->gridWidth) ),( (float)(this->gridHeight) ));
            	}
