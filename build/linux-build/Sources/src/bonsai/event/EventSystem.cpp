...
HX_DEFINE_STACK_FRAME(_hx_pos_d06aab7413059a95_5_new,"bonsai.event.EventSystem","new",0xe79c1cf3,"bonsai.event.EventSystem.new","bonsai/event/EventSystem.hx",5,0x63d1081f)
HX_LOCAL_STACK_FRAME(_hx_pos_d06aab7413059a95_8_listen,"bonsai.event.EventSystem","listen",0x63135994,"bonsai.event.EventSystem.listen","bonsai/event/EventSystem.hx",8,0x63d1081f)
HX_LOCAL_STACK_FRAME(_hx_pos_d06aab7413059a95_14_dispatch,"bonsai.event.EventSystem","dispatch",0xb7fe0d47,"bonsai.event.EventSystem.dispatch","bonsai/event/EventSystem.hx",14,0x63d1081f)
namespace bonsai{
namespace event{
...
void EventSystem_obj::listen( ::Dynamic event, ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_d06aab7413059a95_8_listen)
            	}


HX_DEFINE_DYNAMIC_FUNC2(EventSystem_obj,listen,(void))

void EventSystem_obj::dispatch( ::Dynamic event){
            	HX_STACKFRAME(&_hx_pos_d06aab7413059a95_14_dispatch)
            	}
