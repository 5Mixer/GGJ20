...
HX_LOCAL_STACK_FRAME(_hx_pos_459eda6a7759f998_31_start,"bonsai.Engine","start",0x5c022f0a,"bonsai.Engine.start","bonsai/Engine.hx",31,0xa63e5f47)
...
HX_LOCAL_STACK_FRAME(_hx_pos_459eda6a7759f998_26_start,"bonsai.Engine","start",0x5c022f0a,"bonsai.Engine.start","bonsai/Engine.hx",26,0xa63e5f47)
...
HX_LOCAL_STACK_FRAME(_hx_pos_459eda6a7759f998_40_update,"bonsai.Engine","update",0xa6f21e61,"bonsai.Engine.update","bonsai/Engine.hx",40,0xa63e5f47)
HX_LOCAL_STACK_FRAME(_hx_pos_459eda6a7759f998_46_render,"bonsai.Engine","render",0x251603ae,"bonsai.Engine.render","bonsai/Engine.hx",46,0xa63e5f47)
namespace bonsai{
...
HXLINE(  30)					_gthis->update();
            				...
            				void _hx_run(::Array< ::Dynamic> framebuffers){
            					HX_GC_STACKFRAME(&_hx_pos_459eda6a7759f998_31_start)
HXLINE(  31)					_gthis->render(framebuffers->__get(0).StaticCast<  ::kha::Framebuffer >());
            				}
            				HX_END_LOCAL_FUNC1((void))

            				HX_GC_STACKFRAME(&_hx_pos_459eda6a7759f998_29_start)
HXLINE(  30)				::kha::Scheduler_obj::addTimeTask( ::Dynamic(new _hx_Closure_0(_gthis)),( (Float)(0) ),((Float)0.0166666666666666664),null());
HXLINE(  31)				::kha::System_obj::notifyOnFrames( ::Dynamic(new _hx_Closure_1(_gthis)));
HXLINE(  33)				_gthis->_hx_set_debugInterface(HX_CTX,  ::zui::Zui_obj::__alloc( HX_CTX , ::Dynamic(hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("font",cf,5d,c0,43),::kha::Assets_obj::fonts->SourceSansPro))));
HXLINE(  35)				onReady();
            			}
            			HX_END_LOCAL_FUNC0((void))

            			HX_GC_STACKFRAME(&_hx_pos_459eda6a7759f998_26_start)
HXLINE(  27)			_gthis->_hx_set_input(HX_CTX,  ::bonsai::input::Input_obj::__alloc( HX_CTX ));
HXLINE(  29)			::kha::Assets_obj::loadEverything( ::Dynamic(new _hx_Closure_2(_gthis,onReady)),null(),null(),null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            		::String title = __o_title;
            		if (hx::IsNull(__o_title)) title = HX_("Bonsai Engine Game",ca,78,d7,2d);
            		int width = __o_width.Default(1200);
            		int height = __o_height.Default(900);
            	HX_GC_STACKFRAME(&_hx_pos_459eda6a7759f998_24_start)
HXDLIN(  24)		 ::bonsai::Engine _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE(  25)		::haxe::Log_obj::trace(width,hx::SourceInfo(HX_("bonsai/Engine.hx",47,5f,3e,a6),25,HX_("bonsai.Engine",16,2d,d4,03),HX_("start",62,74,0b,84)));
HXLINE(  26)		::kha::System_obj::start( ::kha::SystemOptions_obj::__alloc( HX_CTX ,title,width,height,null(),null()), ::Dynamic(new _hx_Closure_3(_gthis,onReady)));
            	}
...
void Engine_obj::update(){
            	HX_STACKFRAME(&_hx_pos_459eda6a7759f998_40_update)
HXLINE(  41)		Float delta = ::kha::Scheduler_obj::time();
HXDLIN(  41)		Float delta1 = (delta - this->time);
HXLINE(  42)		this->currentScene->update(delta1);
HXLINE(  43)		this->time = ::kha::Scheduler_obj::time();
            	}
...
void Engine_obj::render( ::kha::Framebuffer framebuffer){
            	HX_STACKFRAME(&_hx_pos_459eda6a7759f998_46_render)
HXLINE(  47)		 ::kha::graphics2::Graphics g = framebuffer->get_g2();
HXLINE(  48)		g->begin(null(),null());
HXLINE(  49)		this->currentScene->render(g);
HXLINE(  50)		g->end();
HXLINE(  52)		this->debugInterface->begin(g);
HXLINE(  53)		g->set_opacity(((Float)1.));
            	}
